...
import { ArrowLeft, Play, User } from 'lucide-vue-next';

export default {
    name: 'MovieDetail',
    components: { ArrowLeft, Play, User },
    data() {
        return {
            movie: null,
            loading: true,
...
.detail-meta { display: flex; gap: 14px; color: #ddd; font-size: 0.95rem; margin-bottom: 20px; }
